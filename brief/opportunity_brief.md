...
> "Constantly pausing in the middle of songs" &mdash; review `09c43170-988c-43d6-b7e0-d0c7982bc80a` (1★)
>
> "U cannot even listen to a single song anymore...it will stop randomly..just so u buy premium and it will not stop anymore...from the best music FREE app, it became the WORST MUSIC PAID APP...do not install" &mdash; review `168a9227-c19e-45f4-bfa0-5ae8b8103172` (1★)
>
> "I like it but every time I try to listen to music now after the last update it keeps skipping" &mdash; review `2d9614f2-5643-4d42-a384-0efa78b5f940` (1★)
...
> "Many songs aren't available in my country" &mdash; review `8770fe52-2d02-4dea-ac43-8f2af39dab04` (4★)
>
> "it's says songs not available on your country" &mdash; review `e7a3930a-8637-4af4-8c40-8def8e9c874d` (1★)
>
> "every time I wanna play a song it keeps saying not available in your country" &mdash; review `dbc9e582-5fe7-40a6-bda5-6dbb1a471a83` (1★)
...
> "because all u do is give ads u fool" &mdash; review `aa95b04e-18af-4b8f-8f17-fdd23df6897d` (1★)
>
> "sooooo much adds but tellax is crazy 🤪" &mdash; review `f8603647-bc0c-4cee-b160-b83608a12f03` (5★)
>
> "a lot of ads, but it works really well!" &mdash; review `c336c478-ee10-485e-99d0-4bef9ab1712a` (4★)
...
> "my playlist song is not play without internet that not fair please without internet play my music thank you" &mdash; review `ba52820c-ee0e-477b-9552-e87058120e4d` (3★)
>
> "Why does the music can't play when offline anymore? And even after updating, you need to be online to play the music, and also the memory data keeps on stacking, WHY?" &mdash; review `81d2f0ff-31f9-4d35-aba8-85bff6541a48` (1★)
>
> "it not allow songs to play offline as Spotify do it mostly don't contain latest songs available it contains copies improve if kindly" &mdash; review `23caef52-da26-4c6f-89cb-47c481c578a8` (3★)
...
> "it's amazing sometimes my Spotify playlist of 15 hours deletes so if I put it here it does not truly recommend it is not that pay and ads stuff I love it" &mdash; review `027b4a3f-ad3d-4707-be11-1c5147f2ef6e` (4★)
>
> "trash , junk app, when I play songs from my likes playlist, it automatically switch to other playlists playing songs I don't want to hear, over and over again, what a junk , even though I tapped on my likes playlist several times, it still..." &mdash; review `71979c79-08d1-4e9b-a0b6-83f1ecd4b027` (1★)
...
> "I changed my five star to 1 star review because you keep blocking IP addresses and app crashes constantly so I can no longer use your platform 👏👏👏🙄👍" &mdash; review `7c05cc2b-a67c-41d7-ad45-86a964af2726` (1★)
>
> "zero stars. Terrible now. Was good a decade ago. All my liked songs got deleted. any good experice is overpriced. crashes constantly. Recover my liked songs @soundcloud !" &mdash; review `d069507f-d182-41e0-8527-2a7caa617541` (1★)
>
> "crashes constantly. and they recently updated the android auto app to a single sine wave track slider that really messes with my brain (being an engineer). the primary button placement and solid fill was a good call, though" &mdash; review `6b202108-9d1e-4ec0-9094-1e1b035206fc` (1★)
...
> "It keeps removing my liked songs bru, hundreds at a time ts pmo" &mdash; review `757868b0-5abd-4da3-a4e0-62f46caf2a51` (2★)
>
> "sound cloud have removed all my likes songs 🎵" &mdash; review `f343378e-96e4-428d-9681-cae7556a997a` (1★)
>
> "I'm not sure if this is a bug but when I was liking songs the songs wouldn't appear in the list for some reason... great app though! 24/3/26 update I came back to SoundCloud but the log in won't work and the help center is useless. I can't..." &mdash; review `249ba095-da91-4e3d-9b21-72e147fc34f2` (1★)
...
> "doesn't let me sign in or login" &mdash; review `02884e3b-a114-4ea9-ac1a-94dadd956a26` (1★)
>
> "can't sign into my account, says it's lost. quite frustrating! won't let me sign in with Facebook either, as I have used this for years!" &mdash; review `9a0d4ff4-9f25-4c9b-90a0-83d2424ee32c` (1★)
>
> "abandoned app. impossible to login." &mdash; review `0f7f21af-df6b-4068-a0da-1d33f3a410ec` (1★)
...
> "we should be able to download songs" &mdash; review `afcbd711-bee5-4106-88d6-a2d058485ee0` (1★)
>
> "if only I could download from this app" &mdash; review `a0d51b3e-0842-4d77-885b-5b5485909991` (3★)
>
> "I love it but why can't I Download a song on it" &mdash; review `c2f85ffe-62e5-4958-906e-5be87574ffbc` (5★)
...
> "500× better than spotify just wish so many songs werent behind premium" &mdash; review `e89f6acc-c2c8-40b9-91ce-470df7ac68f7` (5★)
>
> "SoundCloud is better than YouTube music and Spotify but I have three complaints,why do some songs require me to have SoundCloud Go+ and my songs keep stopping for no reason and the ads are so annoying,I get you need money but it's very ann..." &mdash; review `2333a079-c28e-44f5-9728-70e9b202ad07` (4★)
>
> "some songs you have to pay for" &mdash; review `ceb62922-1451-4654-9e60-43cfe2f4eaf5` (4★)
...
> "will not let me cancel my subscription to Go despite following every instruction, continuing to charge me against my will" &mdash; review `926b44fe-fe2e-4a3b-a6a1-7c2acaafbacf` (1★)
>
> "great app barely any ads unlimited, one issue i cannot cancel my subscription" &mdash; review `c28e7985-b879-4e99-abf6-ec245956856d` (3★)
>
> "Imposible to cancel your premium subscription" &mdash; review `8060ce22-8a8a-4876-8794-171050c439e3` (1★)
...
> "terrible sound quality and unmoderated volume" &mdash; review `cfe34c53-38bd-401e-91db-49a802daceb5` (1★)
>
> "Only good for not having an ad. there's still lot of bugs in app. the sound quality isn't the best. Overall ui looks cheap." &mdash; review `e4592229-6abf-4aad-96a4-bf9458fdf2f7` (3★)
>
> "average app. too expensive. poor sound quality" &mdash; review `5f138a8a-d92d-4667-a030-74533df4b408` (3★)
...
> "Love this app, it just has a bad habit of repeating the same songs over and over again." &mdash; review `aa44f293-314b-4e66-9ce5-073bae440446` (4★)
>
> "you can't repeat the songs. Why is that? if I could listen to a song more than one time I'd give it a five star." &mdash; review `6aca5977-e4e5-4b6c-b9dc-a61115e36fef` (4★)
...
> "bloated mess of an app I remember this running fine years ago but it's totally a mess. compared to youtube music this thing seriously chugs and stutters just doing menial things as you play a song. it's a great platform to find indie music..." &mdash; review `30fd3eb8-3e93-4544-bc68-d68dd9037893` (2★)
>
> "all went down hill when Spotify bought them. app is buggy outdated and not worth the extra cost they added to Go and Go+ which I have payed for for about half a year. honestly a shame and the devs need to actually be payed to fix the app" &mdash; review `0a6de76b-3952-4c07-a21e-1ae2bbc3c96b` (1★)
>
> "This app lags so much it's mad annoying" &mdash; review `7354ec38-a262-4ad5-a33d-a7f430bae1fb` (2★)
...
> "Tried everything to create an account and I also sent a message for help. After 20 minutes of trying everything I couldn't open an account and did not receive any feed back." &mdash; review `356fa6fd-20e6-4aa8-ba70-304d7d0d62aa` (1★)
>
> "Unable to create an account. An error kept on popping up. Uninstalled." &mdash; review `86788d7f-4a65-4867-b366-a13851972d9f` (1★)
>
> "can't even create an account EVERY EMAIL I USE the app says the same thing (Something unexpected happened try again later) I've tried for a week and it done this several times different emails (yes I have multiple) I really like this app l..." &mdash; review `3f5aaf4b-de28-437b-a1cd-208a6715d713` (1★)
...
> "only duplicates and low quality songs available 🫤" &mdash; review `a1f66aba-848f-4215-a7e3-c454fc1c43e7` (1★)
...
> "used to be a fan. I have snippets and tracks uploaded from the 2010s. when I tried recently to download MY TRACKS THAT I CREATED, they hit me with the new subscription paywall. I tried talking to someone and got nowhere. I deleted the app..." &mdash; review `aa6fdb88-398a-44cc-b164-39533dba29e8` (2★)
>
> "Tried everything to create an account and I also sent a message for help. After 20 minutes of trying everything I couldn't open an account and did not receive any feed back." &mdash; review `356fa6fd-20e6-4aa8-ba70-304d7d0d62aa` (1★)
...
> "good app but lack of original artist and need a feature - sleep timer" &mdash; review `75d4d08d-5263-47af-8be4-6d15665c46ed` (3★)
...
> "another price increase? ridiculous" &mdash; review `2a998935-2000-4173-8a43-5c16d43bef73` (1★)
>
> "was a five star app, now with every update it just gets worse and worse connectivity issues, GUI issues, crashing issues I'm on a flagship phone (Samsung) been a loyal customer for a long time and I hate this app more and more with each up..." &mdash; review `c24019b6-c480-4f29-a556-d34674989357` (2★)
>
> "If your going to keep raising prices. Let's at least make the app better because the platform has always been horrible! but theres amazing music on there!" &mdash; review `14ec2198-c0bc-4336-b234-2abdc06bd6ae` (1★)
...
> "its unbelievable,no ads at all" &mdash; review `86ce0114-c53b-43ed-90f6-e8a3855b6aeb` (5★)
>
> "this app is the goat, it doesn't have are for every 1 song or everytime I skip a song" &mdash; review `fd957765-beb6-409c-8e29-6c1be5f156d5` (5★)
